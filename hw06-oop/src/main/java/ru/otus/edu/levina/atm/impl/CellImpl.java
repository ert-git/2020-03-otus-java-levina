...
public class CellImpl implements Cell {
	...
	public void process(Map<Banknote, Integer> bns) {
		...
		// а) банкомат (и ячейка) физически не многопоточные (т.е. одновременно два
		// человека не могут получать и класть деньги)
		// б) если все-таки закладывать на многопоточность, то надо сперва определить
		// порядок нагрузки, время ожидания и т.п.
